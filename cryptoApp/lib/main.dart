...
import 'package:solidity_tutorial/pages%20/eth_conversation/eth_conversions.dart';
import 'package:solidity_tutorial/pages%20/qr_scan/qr_scan_view.dart';
            ...
            itemBuilder: (_) {
              return [
                const PopupMenuItem(
                  ...
                  child: const Text('Connect Previous Session'),
                ),
                const PopupMenuItem(
                ...
                const PopupMenuItem(
                  ...
                  child: const Text('Connect via Code'),
                ),
                const PopupMenuItem(
